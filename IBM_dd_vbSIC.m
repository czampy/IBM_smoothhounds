function [pop,ind] = IBM_dd_vbSIC(n0,beta1,beta2,mortF,p,period,trsz,effk,pfm,gns,stoc)
%IBM_DD_VBSIC Individual-Based Model for Mustelus spp.
%
% IBM integrating density-dependence and using growth parameters from
% literature
%   Inputs:
