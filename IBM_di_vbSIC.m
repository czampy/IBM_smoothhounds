function [pop,ind] = IBM_di_vbSIC(n0,mortF,p,period,trsz,effk,pfm,gns,stoc)
%IBM_DI_VBSIC Individual-Based Model for Mustelus spp.
%
% IBM using growth parameters from literature
%   Inputs:
